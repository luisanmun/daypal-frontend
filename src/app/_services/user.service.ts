...
export class UserService {
  ...
  getCanConfirmMeal(userId: number): Observable<any> {
    return this.http.get(API_URL + '/user/' + userId + '/canConfirmMeal', { responseType: 'text' });
  }

  getCanConfirmExercise(userId: number): Observable<any> {
    return this.http.get(API_URL + '/user/' + userId + '/canConfirmExercise', { responseType: 'text' });
  }
